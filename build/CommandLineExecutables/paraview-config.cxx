...
int main(int argc, char* argv[])
{
  ...
  if (flag == "--libs")
    ...
    std::cout << " -LC:/Program Files/ParaView/lib/paraview-5.3";
#else
    std::cout << " -LC:/Program Files/ParaView/lib/paraview-5.3";
#endif
    ...
    for (vtkModuleNames::const_iterator i = neededModules.begin(); i != neededModules.end(); ++i)
      ...
      if (usePython && modulesWithPython.count(module))
        {
        std::cout << " -l" << module << "PythonD-pv" PARAVIEW_VERSION;
        }
    ...
    {
    std::cout << " -IC:/Program Files/ParaView/include/paraview-5.3" << std::endl;
    }
  else if (flag == "--list")
    {
