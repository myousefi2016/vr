...
#include "../../../src/Qt/Widgets/pqAnimationTrack.h"
...
void pqAnimationTrack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationTrack::propertyChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqAnimationTrack::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationTrack::enabledChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqAnimationTrack::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqAnimationTrack.data,
      qt_meta_data_pqAnimationTrack,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
