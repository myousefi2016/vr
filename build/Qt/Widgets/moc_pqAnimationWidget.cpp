...
#include "../../../src/Qt/Widgets/pqAnimationWidget.h"
...
void pqAnimationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationWidget::trackSelected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqAnimationWidget::*_t)(pqAnimationTrack * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationWidget::deleteTrackClicked)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationWidget::createTrackClicked)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqAnimationWidget::*_t)(pqAnimationTrack * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationWidget::enableTrackClicked)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject pqAnimationWidget::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_pqAnimationWidget.data,
      qt_meta_data_pqAnimationWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
