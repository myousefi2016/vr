...
#include "../../../src/Qt/Widgets/pqAnimationKeyFrame.h"
...
void pqAnimationKeyFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationKeyFrame::startValueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqAnimationKeyFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationKeyFrame::endValueChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqAnimationKeyFrame::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqAnimationKeyFrame::iconChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqAnimationKeyFrame::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqAnimationKeyFrame.data,
      qt_meta_data_pqAnimationKeyFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
