...
#include "../../../src/Qt/Widgets/pqColorChooserButton.h"
...
void pqColorChooserButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqColorChooserButton::chosenColorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqColorChooserButton::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqColorChooserButton::validColorChosen)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqColorChooserButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_pqColorChooserButton.data,
      qt_meta_data_pqColorChooserButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
