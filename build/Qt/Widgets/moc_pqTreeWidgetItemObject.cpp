...
#include "../../../src/Qt/Widgets/pqTreeWidgetItemObject.h"
...
void pqTreeWidgetItemObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTreeWidgetItemObject::checkedStateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTreeWidgetItemObject::modified)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqTreeWidgetItemObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqTreeWidgetItemObject.data,
      qt_meta_data_pqTreeWidgetItemObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
