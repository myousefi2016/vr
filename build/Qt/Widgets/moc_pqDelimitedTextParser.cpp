...
#include "../../../src/Qt/Widgets/pqDelimitedTextParser.h"
...
void pqDelimitedTextParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqDelimitedTextParser::startParsing)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqDelimitedTextParser::parseSeries)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqDelimitedTextParser::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqDelimitedTextParser::finishParsing)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqDelimitedTextParser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqDelimitedTextParser.data,
      qt_meta_data_pqDelimitedTextParser,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
