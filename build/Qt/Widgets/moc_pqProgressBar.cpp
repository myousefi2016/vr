...
#include "../../../src/Qt/Widgets/pqProgressBar.h"
...
struct qt_meta_stringdata_pqProgressBar_t {
    QByteArrayData data[6];
    char stringdata0[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_pqProgressBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pqProgressBar_t qt_meta_stringdata_pqProgressBar = {
    {
QT_MOC_LITERAL(0, 0, 13), // "pqProgressBar"
...
QT_MOC_LITERAL(5, 41, 5) // "value"
    ...
    "pqProgressBar\0reset\0\0setProgress\0"
    "message\0value"
};
...
const QMetaObject pqProgressBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqProgressBar.data,
      qt_meta_data_pqProgressBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *pqProgressBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqProgressBar.stringdata0))
