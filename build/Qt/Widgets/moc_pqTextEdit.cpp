...
#include "../../../src/Qt/Widgets/pqTextEdit.h"
...
void pqTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTextEdit::textChangedAndEditingFinished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqTextEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTextEdit::editingFinished)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqTextEdit::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_pqTextEdit.data,
      qt_meta_data_pqTextEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
