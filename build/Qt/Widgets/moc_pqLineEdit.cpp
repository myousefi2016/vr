...
#include "../../../src/Qt/Widgets/pqLineEdit.h"
...
void pqLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLineEdit::textChangedAndEditingFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject pqLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_pqLineEdit.data,
      qt_meta_data_pqLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
