...
public:
    ...
    void setupUi(QWidget *ColorEditorPropertyWidget)
    {
        ...
        gridLayout->addWidget(RescaleCustom, 1, 2, 1, 1);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/pqWidgets/Icons/pqResetRange24.png"), QSize(), QIcon::Normal, QIcon::Off);
        Rescale->setIcon(icon2);
        Rescale->setFlat(false);

        gridLayout->addWidget(Rescale, 1, 1, 1, 1);

        ShowScalarBar = new QPushButton(ColorEditorPropertyWidget);
        ShowScalarBar->setObjectName(QStringLiteral("ShowScalarBar"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/pqWidgets/Icons/pqScalarBar24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ShowScalarBar->setIcon(icon3);
        ShowScalarBar->setCheckable(true);
        ShowScalarBar->setFlat(false);

        gridLayout->addWidget(ShowScalarBar, 1, 5, 1, 1);

        EditScalarBar = new QPushButton(ColorEditorPropertyWidget);
        EditScalarBar->setObjectName(QStringLiteral("EditScalarBar"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/pqWidgets/Icons/pqEditScalarBar16.png"), QSize(), QIcon::Normal, QIcon::Off);
        EditScalarBar->setIcon(icon4);

        gridLayout->addWidget(EditScalarBar, 1, 6, 1, 1);
        ...
        RescaleTemporal->setIcon(icon5);

        gridLayout->addWidget(RescaleTemporal, 1, 3, 1, 1);

        ChoosePreset = new QPushButton(ColorEditorPropertyWidget);
        ChoosePreset->setObjectName(QStringLiteral("ChoosePreset"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/pqWidgets/Icons/pqFavorites32.png"), QSize(), QIcon::Normal, QIcon::Off);
        ChoosePreset->setIcon(icon6);
        ChoosePreset->setFlat(false);

        gridLayout->addWidget(ChoosePreset, 1, 4, 1, 1);
