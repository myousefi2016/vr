...
#include "../../../src/Qt/ApplicationComponents/pqInteractivePropertyWidget.h"
...
void pqInteractivePropertyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqInteractivePropertyWidget::widgetVisibilityToggled)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqInteractivePropertyWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqInteractivePropertyWidget::widgetVisibilityUpdated)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqInteractivePropertyWidget::startInteraction)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqInteractivePropertyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqInteractivePropertyWidget::interaction)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (pqInteractivePropertyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqInteractivePropertyWidget::endInteraction)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (pqInteractivePropertyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqInteractivePropertyWidget::dummySignal)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject pqInteractivePropertyWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqInteractivePropertyWidget.data,
      qt_meta_data_pqInteractivePropertyWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *pqInteractivePropertyWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqInteractivePropertyWidget.stringdata0))
        return static_cast<void*>(const_cast< pqInteractivePropertyWidget*>(this));
