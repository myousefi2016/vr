...
public:
    ...
    void setupUi(QToolBar *pqCameraToolbar)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/pqWidgets/Icons/pqResetCamera24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/pqWidgets/Icons/pqXPlus24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/pqWidgets/Icons/pqXMinus24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/pqWidgets/Icons/pqYPlus24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/pqWidgets/Icons/pqYMinus24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/pqWidgets/Icons/pqZPlus24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/pqWidgets/Icons/pqZMinus24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/pqWidgets/Icons/pqRotateCameraCW24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/pqWidgets/Icons/pqRotateCameraCCW24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/pqWidgets/Icons/pqZoomToSelection24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/pqWidgets/Icons/pqZoomToData24.png"), QSize(), QIcon::Normal, QIcon::Off);
