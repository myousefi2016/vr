...
public:
    ...
    QAction *actionFileSaveWindowLayout;
    QAction *actionFileLoadWindowLayout;
    ...
    void setupUi(QMenu *pqFileMenuBuilder)
    {
        ...
        actionFileSaveWindowLayout = new QAction(pqFileMenuBuilder);
        actionFileSaveWindowLayout->setObjectName(QStringLiteral("actionFileSaveWindowLayout"));
        actionFileLoadWindowLayout = new QAction(pqFileMenuBuilder);
        actionFileLoadWindowLayout->setObjectName(QStringLiteral("actionFileLoadWindowLayout"));
        ...
        pqFileMenuBuilder->addSeparator();
        pqFileMenuBuilder->addAction(actionFileLoadWindowLayout);
        pqFileMenuBuilder->addAction(actionFileSaveWindowLayout);
        pqFileMenuBuilder->addSeparator();
    ...
    void retranslateUi(QMenu *pqFileMenuBuilder)
    {
        ...
        actionFileSaveWindowLayout->setText(QApplication::translate("pqFileMenuBuilder", "Save Window Layout...", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionFileSaveWindowLayout->setToolTip(QApplication::translate("pqFileMenuBuilder", "Save window layout to a file", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        actionFileSaveWindowLayout->setStatusTip(QApplication::translate("pqFileMenuBuilder", "Save window layout to a file", Q_NULLPTR));
#endif // QT_NO_STATUSTIP
        actionFileLoadWindowLayout->setText(QApplication::translate("pqFileMenuBuilder", "Load Window Layout...", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionFileLoadWindowLayout->setToolTip(QApplication::translate("pqFileMenuBuilder", "Load window layout from a file", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        actionFileLoadWindowLayout->setStatusTip(QApplication::translate("pqFileMenuBuilder", "Load window layout from a file", Q_NULLPTR));
#endif // QT_NO_STATUSTIP
