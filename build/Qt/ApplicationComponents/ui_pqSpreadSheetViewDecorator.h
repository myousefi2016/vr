...
public:
    ...
    void setupUi(QWidget *pqSpreadSheetViewDecorator)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/pqWidgets/Icons/pqSelect16.png"), QSize(), QIcon::Normal, QIcon::Off);
        SelectionOnly->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/pqWidgets/Icons/pqRectilinearGrid16.png"), QSize(), QIcon::Normal, QIcon::Off);
        ToggleColumnVisibility->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/pqWidgets/Icons/pqProgrammableFilter24.png"), QSize(), QIcon::Normal, QIcon::Off);
        ToggleCellConnectivity->setIcon(icon3);
    ...
    void retranslateUi(QWidget *pqSpreadSheetViewDecorator)
    {
        ...
        Attribute->insertItems(0, QStringList()
         << QApplication::translate("pqSpreadSheetViewDecorator", "Points", Q_NULLPTR)
         << QApplication::translate("pqSpreadSheetViewDecorator", "Cells", Q_NULLPTR)
         << QApplication::translate("pqSpreadSheetViewDecorator", "Field Data", Q_NULLPTR)
         << QApplication::translate("pqSpreadSheetViewDecorator", "Vertices", Q_NULLPTR)
         << QApplication::translate("pqSpreadSheetViewDecorator", "Edges", Q_NULLPTR)
         << QApplication::translate("pqSpreadSheetViewDecorator", "Rows", Q_NULLPTR)
        );
