...
public:
    ...
    void setupUi(QWidget *SpherePropertyWidget)
    {
        ...
        SpherePropertyWidget->resize(402, 148);
        ...
        radius = new pqLineEdit(SpherePropertyWidget);
