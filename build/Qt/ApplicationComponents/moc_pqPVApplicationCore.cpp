...
#include "../../../src/Qt/ApplicationComponents/pqPVApplicationCore.h"
...
void pqPVApplicationCore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPVApplicationCore::aboutToShowQuickLaunch)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject pqPVApplicationCore::staticMetaObject = {
    { &pqApplicationCore::staticMetaObject, qt_meta_stringdata_pqPVApplicationCore.data,
      qt_meta_data_pqPVApplicationCore,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
