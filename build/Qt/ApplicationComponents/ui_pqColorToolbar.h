...
public:
    ...
    void setupUi(QToolBar *variableToolbar)
    {
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/pqWidgets/Icons/pqResetRangeTemporal24.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRescaleTemporalRange->setIcon(icon4);
        ...
        const QIcon icon5 = QIcon(QString::fromUtf8(":/pqWidgets/Icons/pqResetToVisibleRange32.png"));
        actionRescaleVisibleRange->setIcon(icon5);
