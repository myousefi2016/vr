...
#ifndef QT_NO_TOOLTIP
        EnableOpacityMapping->setToolTip(QApplication::translate("ColorOpacityEditorWidget", "<html><head/><body><p>When checked, the opacity function is used to render translucent surfaces.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
