...
#include "../../../src/Qt/ApplicationComponents/pqRenderViewSelectionReaction.h"
...
void pqRenderViewSelectionReaction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqRenderViewSelectionReaction::selectedCustomBox)) {
                *result = 0;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqRenderViewSelectionReaction::selectedCustomPolygon)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqRenderViewSelectionReaction::staticMetaObject = {
    { &pqSelectionReaction::staticMetaObject, qt_meta_stringdata_pqRenderViewSelectionReaction.data,
      qt_meta_data_pqRenderViewSelectionReaction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
