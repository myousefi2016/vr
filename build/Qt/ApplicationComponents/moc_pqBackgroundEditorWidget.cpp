...
#include "../../../src/Qt/ApplicationComponents/pqBackgroundEditorWidget.h"
...
void pqBackgroundEditorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqBackgroundEditorWidget::gradientBackgroundChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqBackgroundEditorWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqBackgroundEditorWidget::imageBackgroundChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqBackgroundEditorWidget::staticMetaObject = {
    { &pqPropertyGroupWidget::staticMetaObject, qt_meta_stringdata_pqBackgroundEditorWidget.data,
      qt_meta_data_pqBackgroundEditorWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
