...
#include "../../../src/Qt/Components/pqViewFrame.h"
...
void pqViewFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqViewFrame::buttonPressed)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqViewFrame::actionTriggered)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqViewFrame::swapPositions)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqViewFrame::finishDrag)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject pqViewFrame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqViewFrame.data,
      qt_meta_data_pqViewFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
