...
#include "../../../src/Qt/Components/pqServerConfigurationImporter.h"
...
void pqServerConfigurationImporter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerConfigurationImporter::incrementalUpdate)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqServerConfigurationImporter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerConfigurationImporter::configurationsUpdated)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerConfigurationImporter::authenticationRequired)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqServerConfigurationImporter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerConfigurationImporter::abortFetchTriggered)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerConfigurationImporter::message)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject pqServerConfigurationImporter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqServerConfigurationImporter.data,
      qt_meta_data_pqServerConfigurationImporter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
