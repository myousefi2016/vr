...
"However number of values in both entires must match.", Q_NULLPTR));
        ...
        mode->setToolTip(QApplication::translate("pqComparativeParameterRangeDialog", "Controls the direction in which the paramter is varied.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        mode->setStatusTip(QApplication::translate("pqComparativeParameterRangeDialog", "Controls the direction in which the paramter is varied.", Q_NULLPTR));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        mode->setWhatsThis(QApplication::translate("pqComparativeParameterRangeDialog", "Controls the direction in which the paramter is varied.", Q_NULLPTR));
