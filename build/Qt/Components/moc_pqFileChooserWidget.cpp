...
#include "../../../src/Qt/Components/pqFileChooserWidget.h"
...
void pqFileChooserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqFileChooserWidget::filenamesChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqFileChooserWidget::filenameChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqFileChooserWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqFileChooserWidget.data,
      qt_meta_data_pqFileChooserWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
