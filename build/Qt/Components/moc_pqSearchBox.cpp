...
#include "../../../src/Qt/Components/pqSearchBox.h"
...
void pqSearchBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqSearchBox::advancedSearchActivated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqSearchBox::textChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqSearchBox::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqSearchBox::settingKeyChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqSearchBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqSearchBox.data,
      qt_meta_data_pqSearchBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
