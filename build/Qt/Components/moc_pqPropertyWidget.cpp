...
#include "../../../src/Qt/Components/pqPropertyWidget.h"
...
void pqPropertyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPropertyWidget::viewChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPropertyWidget::changeAvailable)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqPropertyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPropertyWidget::changeFinished)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqPropertyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPropertyWidget::restartRequired)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject pqPropertyWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqPropertyWidget.data,
      qt_meta_data_pqPropertyWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
