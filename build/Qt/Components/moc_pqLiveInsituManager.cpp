...
#include "../../../src/Qt/Components/pqLiveInsituManager.h"
...
void pqLiveInsituManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLiveInsituManager::connectionInitiated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLiveInsituManager::timeUpdated)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqLiveInsituManager::*_t)(pqServer * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLiveInsituManager::breakpointAdded)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqLiveInsituManager::*_t)(pqServer * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLiveInsituManager::breakpointRemoved)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (pqLiveInsituManager::*_t)(pqServer * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLiveInsituManager::breakpointHit)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject pqLiveInsituManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqLiveInsituManager.data,
      qt_meta_data_pqLiveInsituManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
