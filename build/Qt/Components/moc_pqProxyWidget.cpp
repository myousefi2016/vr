...
#include "../../../src/Qt/Components/pqProxyWidget.h"
...
void pqProxyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProxyWidget::changeAvailable)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqProxyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProxyWidget::changeFinished)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqProxyWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProxyWidget::restartRequired)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqProxyWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqProxyWidget.data,
      qt_meta_data_pqProxyWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
