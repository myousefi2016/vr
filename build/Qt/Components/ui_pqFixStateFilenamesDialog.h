...
public:
    ...
    void setupUi(QDialog *FixStateFilenamesDialog)
    {
        if (FixStateFilenamesDialog->objectName().isEmpty())
            FixStateFilenamesDialog->setObjectName(QStringLiteral("FixStateFilenamesDialog"));
    ...
    {
        FixStateFilenamesDialog->setWindowTitle(QApplication::translate("FixStateFilenamesDialog", "Fix Paths in State File", Q_NULLPTR));
    } // retranslateUi
