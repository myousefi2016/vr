...
public:
    ...
    void setupUi(QWidget *pqProxyInformationWidget)
    {
        ...
        filename->setStyleSheet(QStringLiteral("background-color: rgba(0, 0, 0, 0);border: none;"));
        ...
        path->setStyleSheet(QStringLiteral("background-color: rgba(0, 0, 0, 0);border: none;"));
    ...
    void retranslateUi(QWidget *pqProxyInformationWidget)
    {
        ...
        ___qtreewidgetitem->setText(0, QApplication::translate("pqProxyInformationWidget", "Data Hierarchy", Q_NULLPTR));
        ...
        ___qtreewidgetitem1->setText(2, QApplication::translate("pqProxyInformationWidget", "Data Ranges", Q_NULLPTR));
        ___qtreewidgetitem1->setText(1, QApplication::translate("pqProxyInformationWidget", "Data Type", Q_NULLPTR));
        ___qtreewidgetitem1->setText(0, QApplication::translate("pqProxyInformationWidget", "Name", Q_NULLPTR));
        ...
        ___qtreewidgetitem2->setText(1, QApplication::translate("pqProxyInformationWidget", "Value", Q_NULLPTR));
        ___qtreewidgetitem2->setText(0, QApplication::translate("pqProxyInformationWidget", "Index", Q_NULLPTR));
    } // retranslateUi
