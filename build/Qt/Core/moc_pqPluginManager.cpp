...
#include "../../../src/Qt/Core/pqPluginManager.h"
...
void pqPluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPluginManager::pluginsUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPluginManager::requiredPluginsNotLoaded)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqPluginManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqPluginManager.data,
      qt_meta_data_pqPluginManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
