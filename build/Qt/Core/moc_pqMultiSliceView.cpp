...
#include "../../../src/Qt/Core/pqMultiSliceView.h"
...
void pqMultiSliceView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceView::sliceAdded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqMultiSliceView::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceView::sliceRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqMultiSliceView::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceView::sliceModified)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceView::sliceClicked)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject pqMultiSliceView::staticMetaObject = {
    { &pqRenderView::staticMetaObject, qt_meta_stringdata_pqMultiSliceView.data,
      qt_meta_data_pqMultiSliceView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
