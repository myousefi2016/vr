...
#include "../../../src/Qt/Core/pqRepresentation.h"
...
void pqRepresentation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqRepresentation::visibilityChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqRepresentation::updated)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqRepresentation::staticMetaObject = {
    { &pqProxy::staticMetaObject, qt_meta_stringdata_pqRepresentation.data,
      qt_meta_data_pqRepresentation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
