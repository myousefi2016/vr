...
#include "../../../src/Qt/Core/pqPropertyLinks.h"
...
void pqPropertyLinks::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPropertyLinks::qtWidgetChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqPropertyLinks::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPropertyLinks::smPropertyChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqPropertyLinks::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqPropertyLinks.data,
      qt_meta_data_pqPropertyLinks,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
