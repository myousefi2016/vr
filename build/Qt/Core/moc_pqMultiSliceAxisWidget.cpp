...
#include "../../../src/Qt/Core/pqMultiSliceAxisWidget.h"
...
void pqMultiSliceAxisWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceAxisWidget::sliceAdded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqMultiSliceAxisWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceAxisWidget::sliceRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqMultiSliceAxisWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceAxisWidget::sliceModified)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceAxisWidget::markClicked)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqMultiSliceAxisWidget::titleChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject pqMultiSliceAxisWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_pqMultiSliceAxisWidget.data,
      qt_meta_data_pqMultiSliceAxisWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
