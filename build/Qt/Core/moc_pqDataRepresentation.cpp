...
#include "../../../src/Qt/Core/pqDataRepresentation.h"
...
void pqDataRepresentation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqDataRepresentation::dataUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqDataRepresentation::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqDataRepresentation::colorTransferFunctionModified)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqDataRepresentation::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqDataRepresentation::colorArrayNameModified)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqDataRepresentation::staticMetaObject = {
    { &pqRepresentation::staticMetaObject, qt_meta_stringdata_pqDataRepresentation.data,
      qt_meta_data_pqDataRepresentation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
