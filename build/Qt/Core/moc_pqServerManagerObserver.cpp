...
#include "../../../src/Qt/Core/pqServerManagerObserver.h"
...
void pqServerManagerObserver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::compoundProxyDefinitionRegistered)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqServerManagerObserver::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::compoundProxyDefinitionUnRegistered)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::proxyRegistered)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqServerManagerObserver::*_t)(const QString & , const QString & , vtkSMProxy * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::proxyUnRegistered)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::connectionCreated)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (pqServerManagerObserver::*_t)(vtkIdType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::connectionClosed)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::stateLoaded)) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServerManagerObserver::stateSaved)) {
                *result = 7;
                return;
            }
        }
...
const QMetaObject pqServerManagerObserver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqServerManagerObserver.data,
      qt_meta_data_pqServerManagerObserver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
