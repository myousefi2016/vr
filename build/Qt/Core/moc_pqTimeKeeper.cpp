...
#include "../../../src/Qt/Core/pqTimeKeeper.h"
...
void pqTimeKeeper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTimeKeeper::timeStepsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqTimeKeeper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTimeKeeper::timeChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqTimeKeeper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTimeKeeper::timeRangeChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqTimeKeeper::staticMetaObject = {
    { &pqProxy::staticMetaObject, qt_meta_stringdata_pqTimeKeeper.data,
      qt_meta_data_pqTimeKeeper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
