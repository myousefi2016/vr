...
#include "../../../src/Qt/Core/pqUndoStack.h"
...
void pqUndoStack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::stackChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::canUndoChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqUndoStack::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::canRedoChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::undoLabelChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (pqUndoStack::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::redoLabelChanged)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::undone)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (pqUndoStack::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqUndoStack::redone)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject pqUndoStack::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqUndoStack.data,
      qt_meta_data_pqUndoStack,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
