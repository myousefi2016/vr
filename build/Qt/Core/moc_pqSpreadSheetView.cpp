...
#include "../../../src/Qt/Core/pqSpreadSheetView.h"
...
void pqSpreadSheetView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqSpreadSheetView::showing)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqSpreadSheetView::viewportUpdated)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqSpreadSheetView::staticMetaObject = {
    { &pqView::staticMetaObject, qt_meta_stringdata_pqSpreadSheetView.data,
      qt_meta_data_pqSpreadSheetView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
