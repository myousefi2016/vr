...
#include "../../../src/Qt/Core/pqOutputPort.h"
...
void pqOutputPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::connectionAdded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqOutputPort::*_t)(pqOutputPort * , pqPipelineSource * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::preConnectionAdded)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqOutputPort::*_t)(pqOutputPort * , pqPipelineSource * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::connectionRemoved)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqOutputPort::*_t)(pqOutputPort * , pqPipelineSource * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::preConnectionRemoved)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::representationAdded)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (pqOutputPort::*_t)(pqOutputPort * , pqDataRepresentation * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::representationRemoved)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (pqOutputPort::*_t)(pqOutputPort * , pqDataRepresentation * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqOutputPort::visibilityChanged)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject pqOutputPort::staticMetaObject = {
    { &pqServerManagerModelItem::staticMetaObject, qt_meta_stringdata_pqOutputPort.data,
      qt_meta_data_pqOutputPort,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
