...
#include "../../../src/Qt/Core/pqProgressManager.h"
...
QT_MOC_LITERAL(21, 259, 9), // "onMessage"
QT_MOC_LITERAL(22, 269, 13), // "onServerAdded"
QT_MOC_LITERAL(23, 283, 9) // "pqServer*"
    ...
    "vtkObject*\0onMessage\0onServerAdded\0"
    "pqServer*"
};
...
static const uint qt_meta_data_pqProgressManager[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      18,    0,  136,    2, 0x09 /* Protected */,
      19,    1,  137,    2, 0x09 /* Protected */,
      21,    1,  140,    2, 0x09 /* Protected */,
      22,    1,  143,    2, 0x09 /* Protected */,
...
void pqProgressManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: _t->onMessage((*reinterpret_cast< vtkObject*(*)>(_a[1]))); break;
        case 17: _t->onServerAdded((*reinterpret_cast< pqServer*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProgressManager::abort)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProgressManager::progress)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProgressManager::enableProgress)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqProgressManager::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProgressManager::enableAbort)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (pqProgressManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProgressManager::progressStartEvent)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (pqProgressManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqProgressManager::progressEndEvent)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject pqProgressManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqProgressManager.data,
      qt_meta_data_pqProgressManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
