...
#include "../../../src/Qt/Core/pqServer.h"
...
QT_MOC_LITERAL(18, 285, 25), // "processServerNotification"
QT_MOC_LITERAL(19, 311, 28), // "onCollaborationCommunication"
QT_MOC_LITERAL(20, 340, 10), // "vtkObject*"
QT_MOC_LITERAL(21, 351, 16) // "onConnectionLost"
...
static const uint qt_meta_data_pqServer[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      19,    4,  112,    2, 0x09 /* Protected */,
      21,    4,  121,    2, 0x09 /* Protected */,
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 20, QMetaType::ULong, QMetaType::VoidStar, QMetaType::VoidStar,    2,    2,    2,    2,
    QMetaType::Void, 0x80000000 | 20, QMetaType::ULong, QMetaType::VoidStar, QMetaType::VoidStar,    2,    2,    2,    2,
...
void pqServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::nameChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::fiveMinuteTimeoutWarning)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::finalTimeoutWarning)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::serverSideDisconnected)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::sentFromOtherClient)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::triggeredMasterUser)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::triggeredUserName)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (pqServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::triggeredUserListChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (pqServer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqServer::triggerFollowCamera)) {
                *result = 8;
                return;
            }
        }
...
const QMetaObject pqServer::staticMetaObject = {
    { &pqServerManagerModelItem::staticMetaObject, qt_meta_stringdata_pqServer.data,
      qt_meta_data_pqServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
