...
#include "../../../src/Qt/Core/pqLinksModel.h"
...
void pqLinksModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLinksModel::linkAdded)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLinksModel::linkRemoved)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqLinksModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_pqLinksModel.data,
      qt_meta_data_pqLinksModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void pqLinksModelObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqLinksModelObject::linkRemoved)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject pqLinksModelObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqLinksModelObject.data,
      qt_meta_data_pqLinksModelObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
