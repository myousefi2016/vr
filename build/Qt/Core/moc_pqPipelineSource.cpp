...
#include "../../../src/Qt/Core/pqPipelineSource.h"
...
void pqPipelineSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::connectionAdded)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqPipelineSource::*_t)(pqPipelineSource * , pqPipelineSource * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::preConnectionAdded)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqPipelineSource::*_t)(pqPipelineSource * , pqPipelineSource * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::connectionRemoved)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqPipelineSource::*_t)(pqPipelineSource * , pqPipelineSource * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::preConnectionRemoved)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::representationAdded)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (pqPipelineSource::*_t)(pqPipelineSource * , pqDataRepresentation * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::representationRemoved)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::visibilityChanged)) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPipelineSource::dataUpdated)) {
                *result = 7;
                return;
            }
        }
...
const QMetaObject pqPipelineSource::staticMetaObject = {
    { &pqProxy::staticMetaObject, qt_meta_stringdata_pqPipelineSource.data,
      qt_meta_data_pqPipelineSource,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
