...
void pqView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::updateDataEvent)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::representationAdded)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqView::*_t)(pqRepresentation * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::representationRemoved)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (pqView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::beginRender)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (pqView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::endRender)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::representationVisibilityChanged)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::canUndoChanged)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (pqView::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::canRedoChanged)) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::selected)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (pqView::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::selectionModeChanged)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (pqView::*_t)(pqOutputPort * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::picked)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (pqView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::beginProgress)) {
                *result = 11;
                return;
            }
        }
        {
            typedef void (pqView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::endProgress)) {
                *result = 12;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::progress)) {
                *result = 13;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqView::multipleSelected)) {
                *result = 14;
                return;
            }
        }
...
const QMetaObject pqView::staticMetaObject = {
    { &pqProxy::staticMetaObject, qt_meta_stringdata_pqView.data,
      qt_meta_data_pqView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
