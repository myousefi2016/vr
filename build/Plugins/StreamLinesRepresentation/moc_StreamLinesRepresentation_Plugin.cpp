...
const QMetaObject StreamLinesRepresentation_Plugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StreamLinesRepresentation_Plugin.data,
      qt_meta_data_StreamLinesRepresentation_Plugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StreamLinesRepresentation_Plugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StreamLinesRepresentation_Plugin.stringdata0))
        return static_cast<void*>(const_cast< StreamLinesRepresentation_Plugin*>(this));
    if (!strcmp(_clname, "vtkPVGUIPluginInterface"))
        return static_cast< vtkPVGUIPluginInterface*>(const_cast< StreamLinesRepresentation_Plugin*>(this));
    if (!strcmp(_clname, "vtkPVPlugin"))
        return static_cast< vtkPVPlugin*>(const_cast< StreamLinesRepresentation_Plugin*>(this));
    if (!strcmp(_clname, "vtkPVServerManagerPluginInterface"))
        return static_cast< vtkPVServerManagerPluginInterface*>(const_cast< StreamLinesRepresentation_Plugin*>(this));
