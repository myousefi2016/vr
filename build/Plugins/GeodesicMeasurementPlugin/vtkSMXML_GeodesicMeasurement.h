...
// From file C:/Users/vr/Desktop/ParaView-v5.3.0-VR/src/Plugins/GeodesicMeasurementPlugin/GeodesicMeasurement.xml
...
{
  size_t len = ( 0
    + strlen(GeodesicMeasurementGeodesicMeasurementInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, GeodesicMeasurementGeodesicMeasurementInterfaces0);
  return res;
}
