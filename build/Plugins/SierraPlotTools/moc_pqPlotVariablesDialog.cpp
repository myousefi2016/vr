...
#include "../../../src/Plugins/SierraPlotTools/pqPlotVariablesDialog.h"
...
void pqPlotVariablesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPlotVariablesDialog::variableSelected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPlotVariablesDialog::variableDeselectionByName)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqPlotVariablesDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPlotVariablesDialog::variableSelectionByName)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPlotVariablesDialog::okDismissed)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (pqPlotVariablesDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPlotVariablesDialog::cancelDismissed)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (pqPlotVariablesDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqPlotVariablesDialog::useParaViewGUIToSelectNodesCheck)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject pqPlotVariablesDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pqPlotVariablesDialog.data,
      qt_meta_data_pqPlotVariablesDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *pqPlotVariablesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pqPlotVariablesDialog.stringdata0))
        return static_cast<void*>(const_cast< pqPlotVariablesDialog*>(this));
