...
// From file C:/Users/vr/Desktop/ParaView-v5.3.0-VR/src/Plugins/ArrowGlyph/vtkArrowGlyphFilter.xml
...
{
  size_t len = ( 0
    + strlen(ArrowGlyphvtkArrowGlyphFilterInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, ArrowGlyphvtkArrowGlyphFilterInterfaces0);
  return res;
}
