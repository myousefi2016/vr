...
#ifndef QT_NO_TOOLTIP
        actionShowStandardViewpoint->setToolTip(QApplication::translate("pqSLACActionHolder", "Position the camera in a position convienient to see the entire mesh.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
