...
// From file C:/Users/vr/Desktop/ParaView-v5.3.0-VR/src/Plugins/SLACTools/SLACToolsSM.xml
...
{
  size_t len = ( 0
    + strlen(SLACToolsSLACToolsSMInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, SLACToolsSLACToolsSMInterfaces0);
  return res;
}
