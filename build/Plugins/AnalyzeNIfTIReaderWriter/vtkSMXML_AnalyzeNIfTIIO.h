...
// From file C:/Users/vr/Desktop/ParaView-v5.3.0-VR/src/Plugins/AnalyzeNIfTIReaderWriter/AnalyzeNIfTISM.xml
...
{
  size_t len = ( 0
    + strlen(AnalyzeNIfTIIOAnalyzeNIfTISMInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, AnalyzeNIfTIIOAnalyzeNIfTISMInterfaces0);
  return res;
}
