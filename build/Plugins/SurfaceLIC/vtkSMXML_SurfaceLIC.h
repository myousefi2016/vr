...
// From file C:/Users/vr/Desktop/ParaView-v5.3.0-VR/src/Plugins/SurfaceLIC/vtkSurfaceLICRepresentation.xml
...
{
  size_t len = ( 0
    + strlen(SurfaceLICvtkSurfaceLICRepresentationInterfaces0)
    + strlen(SurfaceLICvtkSurfaceLICRepresentationInterfaces1)
    + strlen(SurfaceLICvtkSurfaceLICRepresentationInterfaces2) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, SurfaceLICvtkSurfaceLICRepresentationInterfaces0);
  strcat(res, SurfaceLICvtkSurfaceLICRepresentationInterfaces1);
  strcat(res, SurfaceLICvtkSurfaceLICRepresentationInterfaces2);
  return res;
}
