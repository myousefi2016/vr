...
// From file C:/Users/vr/Desktop/ParaView-v5.3.0-VR/src/Plugins/GMVReader/GMVReaderSM.xml
...
{
  size_t len = ( 0
    + strlen(GMVReaderGMVReaderSMInterfaces0) );
  char* res = new char[ len + 1];
  res[0] = 0;
  strcat(res, GMVReaderGMVReaderSMInterfaces0);
  return res;
}
