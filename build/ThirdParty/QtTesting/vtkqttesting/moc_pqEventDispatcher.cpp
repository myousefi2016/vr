...
#include "../../../../src/ThirdParty/QtTesting/vtkqttesting/pqEventDispatcher.h"
...
void pqEventDispatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventDispatcher::restarted)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqEventDispatcher::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventDispatcher::paused)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqEventDispatcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqEventDispatcher.data,
      qt_meta_data_pqEventDispatcher,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
