...
#include "../../../../src/ThirdParty/QtTesting/vtkqttesting/pqEventTranslator.h"
...
void pqEventTranslator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventTranslator::recordEvent)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventTranslator::started)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (pqEventTranslator::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventTranslator::stopped)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqEventTranslator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqEventTranslator.data,
      qt_meta_data_pqEventTranslator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
