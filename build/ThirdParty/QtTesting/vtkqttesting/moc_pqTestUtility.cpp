...
#include "../../../../src/ThirdParty/QtTesting/vtkqttesting/pqTestUtility.h"
...
void pqTestUtility::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTestUtility::playbackStarted)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqTestUtility::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqTestUtility::playbackStopped)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject pqTestUtility::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqTestUtility.data,
      qt_meta_data_pqTestUtility,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
