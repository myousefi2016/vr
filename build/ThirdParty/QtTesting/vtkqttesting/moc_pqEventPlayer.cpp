...
#include "../../../../src/ThirdParty/QtTesting/vtkqttesting/pqEventPlayer.h"
...
void pqEventPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventPlayer::eventAboutToBePlayed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (pqEventPlayer::*_t)(const QString & , const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventPlayer::eventPlayed)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventPlayer::errorMessage)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqEventPlayer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqEventPlayer.data,
      qt_meta_data_pqEventPlayer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
