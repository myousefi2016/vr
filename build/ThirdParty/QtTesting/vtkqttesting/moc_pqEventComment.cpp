...
#include "../../../../src/ThirdParty/QtTesting/vtkqttesting/pqEventComment.h"
...
void pqEventComment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqEventComment::recordComment)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject pqEventComment::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqEventComment.data,
      qt_meta_data_pqEventComment,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
