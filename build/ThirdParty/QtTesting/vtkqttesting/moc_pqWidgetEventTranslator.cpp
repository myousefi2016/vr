...
#include "../../../../src/ThirdParty/QtTesting/vtkqttesting/pqWidgetEventTranslator.h"
...
void pqWidgetEventTranslator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqWidgetEventTranslator::recordEvent)) {
                *result = 0;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&pqWidgetEventTranslator::specificOverlay)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject pqWidgetEventTranslator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqWidgetEventTranslator.data,
      qt_meta_data_pqWidgetEventTranslator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
