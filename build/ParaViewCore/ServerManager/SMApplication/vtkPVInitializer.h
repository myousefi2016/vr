...
extern "C" void vtkIOMPIParallelCS_Initialize(vtkClientServerInterpreter*);
...
void PARAVIEW_CSSTREAMS_INITIALIZE(vtkClientServerInterpreter* interp)
{
  ...
  vtkFiltersParallelGeometryCS_Initialize(interp);
  ...
  vtkIOMPIParallelCS_Initialize(interp);
  ...
  public vtkPVServerManagerPluginInterface
{
  ...
  xmls.push_back(init_string);
  delete[] init_string; init_string = NULL;
  init_string =  vtkSMDefaultModulesproxies_mpiGetInterfaces();
  xmls.push_back(init_string);
  delete[] init_string; init_string = NULL;
  init_string =  vtkSMDefaultModulesproxies_opengl2GetInterfaces();
  xmls.push_back(init_string);
  delete[] init_string; init_string = NULL;
    (void) init_string;
    }
