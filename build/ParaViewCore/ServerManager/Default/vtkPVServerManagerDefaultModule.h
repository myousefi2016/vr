...
#      define VTKPVSERVERMANAGERDEFAULT_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define VTKPVSERVERMANAGERDEFAULT_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define VTKPVSERVERMANAGERDEFAULT_DEPRECATED __declspec(deprecated)
#  define VTKPVSERVERMANAGERDEFAULT_DEPRECATED_EXPORT VTKPVSERVERMANAGERDEFAULT_EXPORT __declspec(deprecated)
#  define VTKPVSERVERMANAGERDEFAULT_DEPRECATED_NO_EXPORT VTKPVSERVERMANAGERDEFAULT_NO_EXPORT __declspec(deprecated)
#endif
