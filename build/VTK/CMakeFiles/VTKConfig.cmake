...
set(_vtk_installed_prefix "C:/Program Files/ParaView/lib/cmake/paraview-5.3")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "C:/Program Files/ParaView")
else ()
...
set(VTK_MODULES_DIR "${VTK_INSTALL_PREFIX}/lib/cmake/paraview-5.3/Modules")
...
SET(VTK_CMAKE_DIR "${VTK_INSTALL_PREFIX}/lib/cmake/paraview-5.3")
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Program Files/ParaView/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Program Files/ParaView/lib/paraview-5.3")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Users/vr/Desktop/ParaView-v5.3.0-VR/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Users/vr/Desktop/ParaView-v5.3.0-VR/build/lib")
  endif ()
endif()
...
# Import VTK targets.
set(VTK_CONFIG_TARGETS_FILE "${VTK_INSTALL_PREFIX}/lib/cmake/paraview-5.3/VTKTargets.cmake")
if(NOT TARGET vtkCommonCore)
  include("${VTK_CONFIG_TARGETS_FILE}")
endif()

# Load module interface macros.
include("${VTK_INSTALL_PREFIX}/lib/cmake/paraview-5.3/vtkModuleAPI.cmake")
