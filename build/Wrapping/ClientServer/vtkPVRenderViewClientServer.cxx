...
int VTK_EXPORT vtkPVRenderViewCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetEGLDeviceIndex",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->SetEGLDeviceIndex(temp0);
      return 1;
      }
    }
  ...
  if (!strcmp("ClearOrderedCompositingInformation",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->ClearOrderedCompositingInformation();
      return 1;
      }
    }
