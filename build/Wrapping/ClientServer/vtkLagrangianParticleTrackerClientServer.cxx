...
int VTK_EXPORT vtkLagrangianParticleTrackerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetCreateOutOfDomainParticle",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->SetCreateOutOfDomainParticle(temp0);
      return 1;
      }
    }
  if (!strcmp("GetCreateOutOfDomainParticle",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetCreateOutOfDomainParticle();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("CreateOutOfDomainParticleOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->CreateOutOfDomainParticleOn();
      return 1;
      }
    }
  if (!strcmp("CreateOutOfDomainParticleOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->CreateOutOfDomainParticleOff();
      return 1;
      }
    }
