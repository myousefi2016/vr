...
int VTK_EXPORT vtkLagrangianBasicIntegrationModelCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetCurrentParticle",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkLagrangianParticle  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkLagrangianParticle"))
      {
      op->SetCurrentParticle(temp0);
      return 1;
      }
    }
  ...
  if (!strcmp("InsertVariablesParticleData",method) && msg.GetNumberOfArguments(0) == 5)
    {
    vtkLagrangianParticle  *temp0;
    vtkPointData  *temp1;
    int      temp2;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkLagrangianParticle") &&
      ...
      msg.GetArgument(0, 4, &temp2))
      {
      op->InsertVariablesParticleData(temp0,temp1,temp2);
      return 1;
      }
    }
  if (!strcmp("InitializeParticle",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkLagrangianParticle  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkLagrangianParticle"))
      {
      op->InitializeParticle(temp0);
      return 1;
      }
    }
  if (!strcmp("CheckFreeFlightTermination",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkLagrangianParticle  *temp0;
    bool   temp20;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkLagrangianParticle"))
      {
      temp20 = (op)->CheckFreeFlightTermination(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("ParallelManualShift",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkLagrangianParticle  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkLagrangianParticle"))
      {
      op->ParallelManualShift(temp0);
      return 1;
      }
    }
