...
int VTK_EXPORT vtkSpreadSheetViewCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("SetColumnVisibility",method) && msg.GetNumberOfArguments(0) == 5)
    {
    int      temp0;
    char    *temp1;
    int      temp2;
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      {
      op->SetColumnVisibility(temp0,temp1,temp2);
      return 1;
      }
    }
  if (!strcmp("ClearColumnVisibilities",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->ClearColumnVisibilities();
      return 1;
      }
    }
  ...
  if (!strcmp("FetchBlockCallback",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    bool   temp1;
    vtkTable  *temp20;
    if(msg.GetArgument(0, 2, &temp0) &&
      msg.GetArgument(0, 3, &temp1))
      {
      temp20 = (op)->FetchBlockCallback(temp0,temp1);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
