...
int VTK_EXPORT vtkPVSessionBaseCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("ExecuteStream",method) && msg.GetNumberOfArguments(0) == 5)
    {
    unsigned int      temp0;
    vtkClientServerStream temp1_inst, *temp1 = &temp1_inst;
    bool   temp2;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("GetLastResult",method) && msg.GetNumberOfArguments(0) == 3)
    {
    unsigned int      temp0;
    const vtkClientServerStream temp20_inst, *temp20 = &temp20_inst;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = &(op)->GetLastResult(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << *temp20 << vtkClientServerStream::End;
      return 1;
      }
